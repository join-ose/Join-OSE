...
def soPRF(in1, in2):
    ...
    return _soPRF_prim.bind(in1, in2)
...
def _soPRF_lowering(ctx, in1, in2):
...
# *********************************************
_soPRF_prim = core.Primitive("soPRF")
# Change this to True if there are more than 1 output
_soPRF_prim.multiple_results = False
_soPRF_prim.def_impl(partial(xla.apply_primitive, _soPRF_prim))
_soPRF_prim.def_abstract_eval(_soPRF_abstract)

mlir.register_lowering(_soPRF_prim, _soPRF_lowering)

# Connect the JVP and batching rules
ad.primitive_jvps[_soPRF_prim] = _soPRF_jvp
batching.primitive_batchers[_soPRF_prim] = _soPRF_batch
